...
<script>
	...
	$(document).ready(function(){
		...
		$('#search').keyup(function(){
			...
			if(search==''){
				window.history.pushState("object or string", "Daftar PKT : "+search, "pkt.php");
			}else{
				window.history.pushState("object or string", "Daftar PLT : "+search, "pkt.php?search="+search);
			}
		});
			...
			<div class="panel-heading">
				<?php
						if($status=='anggota'){
							...
							echo "Daftar Mahasiswa yang mendaftar PKT";
						}
				 ?>
